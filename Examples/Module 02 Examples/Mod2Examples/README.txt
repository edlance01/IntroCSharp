...
3. In Rider, right-click on the project in the Solution Explorer, and select "Edit", and then "Edit Mod2Examples.csproj".
...
<Project Sdk="Microsoft.NET.Sdk">
	<PropertyGroup>
		<StartupObject>Mod2Example01.Program</StartupObject>
