...
3. In Rider, right-click on the project in the Solution Explorer, and select "Edit", and then "Edit Mod6Examples.csproj".
...
<Project Sdk="Microsoft.NET.Sdk">
	<PropertyGroup>
		<StartupObject>Mod6Example01.Program</StartupObject>
