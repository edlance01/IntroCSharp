...
3. In Rider, right-click on the project in the Solution Explorer, and select "Edit", and then "Edit Mod5Examples.csproj".
...
<Project Sdk="Microsoft.NET.Sdk">
	<PropertyGroup>
		<StartupObject>Mod5Examples01.Program</StartupObject>
