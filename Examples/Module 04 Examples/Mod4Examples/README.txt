...
3. In Rider, right-click on the project in the Solution Explorer, and select "Edit", and then "Edit Mod4Examples.csproj".
...
NOTE:  <StartupObject>namespace.Program</StartupObject>
<Project Sdk="Microsoft.NET.Sdk">
	<PropertyGroup>
		<StartupObject>Mod4Example05.Program</StartupObject>
